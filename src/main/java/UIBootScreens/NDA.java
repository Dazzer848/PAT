...
public class NDA extends javax.swing.JFrame {
    ...
    private void DisclaimerCheckBoxThread(){
        NDABoxThread DisclaimerBoxs = new NDABoxThread(NDA, LossOrHarm, Death, Painetc, LossOfLimbs, Censorship, ToHaveAGoodTime);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NDA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
